...
def crck(momo,pq,mb,QRS,mk,mf):
    ...
    for i in range(0,1):
        ...
        (data,pk)=pkdt.peakdt(sf,pq1,crt,pts,mf)
        print('   ')
        print('   ')
        ...
        #pq=1
        #momo=1
        (ss1,q1,q2,q3,q4,q5,tsv1,dc1)=comfnc.dcom(tsv,1,sf,mb,pq,momo,QRS,data,pk)
        print('   ')
        print('   ')
        ...
        mmx=0
        #print('tsv1', tsv1)
        (cr,er,recon, orgi,)=decomfnc.decomdata(tsv1,mm,mmx,ss1,dc1)
        if momo>0:
            ff=er[12,1]
            ff1=er[12,0]
            q21=q2*ff/ff1
    ...
    return(cr,er,tsv1,ff,data, pk, recon, orgi,ss1)
